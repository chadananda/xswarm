...
const articles = [
  { slug: 'expensive-ai-intern', title: 'Your AI Coding Assistant\\nis Actually a\\nVery Expensive Intern', color1: '#00ffff', color2: '#ff00ff' },
  { slug: 'sequential-hell', title: 'Why AI Development\\nis Still Stuck in 1995\\n(Sequential Hell Edition)', color1: '#ff00ff', color2: '#00ff00' },
  { slug: 'ai-function-graveyard', title: 'AI Function Graveyard:\\nWhy Multi-Pass Planning\\nCould Save Your Codebase', color1: '#00ff00', color2: '#ffff00' },
  { slug: 'sandboxed-integration', title: 'AI Integration Testing:\\nWhy Sandboxed Teams\\nAre the Final Boss Solution', color1: '#ffff00', color2: '#00ffff' },
  { slug: 'interactive-prototypes', title: 'Interactive AI Prototypes\\nvs. Static Mockups:\\nThe UX Revolution', color1: '#ff00ff', color2: '#00ff00' },
  { slug: 'marketing-during-dev', title: 'Why AI Marketing\\nShould Happen\\nDuring Development', color1: '#00ffff', color2: '#ff00ff' },
  { slug: 'technical-debt-antidote', title: 'Multi-Pass AI Planning:\\nThe Antidote to\\nTechnical Debt Poisoning', color1: '#00ff00', color2: '#ffff00' },
  { slug: 'swarm-commander', title: 'From AI Prompt Engineer\\nto AI Swarm Commander:\\nThe Evolution', color1: '#ffff00', color2: '#ff00ff' },
  { slug: 'three-minute-standups', title: 'Why AI Standups\\nAre 3 Minutes When\\nEveryone Lives in Sandboxes', color1: '#ff00ff', color2: '#00ffff' },
  { slug: 'ai-epoch-manifesto', title: 'The AI Epoch Manifesto:\\nRecursive Planning for\\nRecursive Intelligence', color1: '#00ffff', color2: '#00ff00' },
  { slug: 'forty-hidden-agents', title: 'The 40 AI Agents\\nNobody Told You About\\n(And Why You Need Them)', color1: '#00ff00', color2: '#ff00ff' },
  { slug: 'token-economics', title: 'Token Economics:\\nWhy Your AI is\\nBurning Money on Hello World', color1: '#ffff00', color2: '#00ffff' }
];
...
async function generatePlaceholder(article) {
  ...
  const outputPath = path.join(__dirname, '..', 'website', 'public', 'images', 'blog', `${article.slug}-hero.jpg`);
  
  await sharp(Buffer.from(circuitPattern))
    .jpeg({ quality: 90 })
    .toFile(outputPath);
